...
namespace Micro_Finance
{
    public partial class frmCus : Form
    {
        ...
        public void LoadData(string pAction)
        {
            ...
            try
            {
                DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "LOAD_DATA_CUS", t_search.Text.Trim() + "[.,;TNC,;.]" + pAction + "[.,;TNC,;.]" + vPage }, ClsGlouble.f_string(c_branch.SelectedValue));
                dgv.Rows.Clear();
                int i = 1;
        ...
        private void tsbAdd_Click(object sender, EventArgs e)
        {
            ...
            frmCSUb.vAction = "ADD";
            frmCSUb.vDb = ClsGlouble.f_string(c_branch.SelectedValue);
            frmCSUb.fCus = this;
            frmCSUb.ShowDialog();
        }
        ...
        private void tsbEdit_Click(object sender, EventArgs e)
        {
            ...
            if (dgv.CurrentCell != null)
            {
                ...
                frmCos.vAction = "EDIT";
                frmCos.vDb = ClsGlouble.f_string(c_branch.SelectedValue);
                frmCos.fCus = this;
            ...
            try
            {
                if (dgv.CurrentCell != null)
                {
                    ...
                    if (dr == DialogResult.Yes)
                    {
                        ...
                        DataSet ds = ClsGlouble.GetDataset("PRO_DATA_MANAGER", new string[] { "DELETE_CUS", id + "" },ClsGlouble.f_string(c_branch.SelectedValue));
